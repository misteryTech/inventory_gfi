    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <form action="request_items.php" method="POST">
                    <div class="mb-3">
                        <label for="staffId" class="form-label">Staff ID </label>
                        <input type="text" id="staff_id" name="staff_id" value="<?php echo  $staff_id; ?>">
                    </div>
            ...
            <div class="col-md-7">
                ...
                <table class="table table-striped" id="requestedItemsTable">
                    ...
                    <tbody>
                    <?php
                    $staff_id = $_SESSION['staff_id']; // Ensure the staff_id is obtained properly
                    
                    // Query for requested items
                    $sqlRequestedItems = "
                        SELECT rt.request_id, rt.request_date, rt.status, rt.reason
                        FROM requests_table rt
                        WHERE rt.staff_id = '$staff_id'";
                    ...
                    if ($resultRequestedItems->num_rows > 0) {
                        while ($row = $resultRequestedItems->fetch_assoc()) {
                            ...
                            echo "<td>
                                <button class='btn btn-primary btn-sm view-btn' data-id='" . $row['request_id'] . "'>View</button>
                              </td>";
                            echo "</tr>";
                        }
                    } else {
